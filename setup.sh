...
docker run -d --restart=always --name dashtest -p $testapi:3001 -p $testrpc:18332 -p $testinbound:18333 -v $current/dashtestnet:/root/.dashcore figassis/docker-bitcore:dash
docker run -d --restart=always --name dashmain -p $mainapi:3001 -p $mainrpc:8332 -p $maininbound:8333 -v $current/dashmainnet:/root/.dashcore figassis/docker-bitcore:dash  
